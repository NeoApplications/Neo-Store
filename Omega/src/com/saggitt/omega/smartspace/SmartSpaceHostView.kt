...
class SmartSpaceHostView(context: Context?) : QsbWidgetHostView(context), OnLongClickListener,
    ...
    override fun onLongClick(view: View): Boolean {
        ...
        val item = OptionItem(
            context.getString(R.string.smartspace_preferences),
            context.getDrawable(R.drawable.ic_smartspace_preferences), NexusLauncherEnum.SMARTSPACE_TAP_OR_LONGPRESS
